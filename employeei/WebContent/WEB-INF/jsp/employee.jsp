...
<body>
			...
			<tr>
				<td align="right"><Span
					style="font-weight: bold; color: black; padding: 12px 20px;">Address
						: </Span></td>
				<td><textarea rows="4" cols="50" name="address" maxlenght="1000"></textarea></td>
			</tr>
			<tr>
				<td align="right"><Span
					style="font-weight: bold; color: black; padding: 12px 20px;">Phone
						: </Span></td>
				<td><input type="text" name="empphone" maxlength="12" /></td>
			</tr>
			<tr>
				<td align="right"><Span
	...
	<form action="EmpGrid" method="post" name="form2">
		<table id="table2" class="table table-bordered table-striped" border="1" cellpadding="0" cellspacing="0"
			...
			<tr>
				...
				<td valign="top"><input type="hidden"
					name="erid<%out.print(i);%>" value="${e.empid}" />${e.empid}</td>
				<td valign="top"><input type="text"
					name="ename<%out.print(i);%>" value="${e.empname}"
				...
				<td valign="top"><input type="text" value="${e.address}"
				...
				<td valign="top"><input type="text"
					...
					readonly="readonly" onchange="setapply(<%out.print(i);%>);" /></td>
			</tr>
			</c:forEach>
			</tbody>
		</table>
